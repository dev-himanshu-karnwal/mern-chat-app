...
const ChatMessageContextMenu = ({ onPermanentlyDelete, onPersonallyDelete ,messageSender}) => {
  return (
    <div className={`bg-gray-800 shadow-lg border rounded p-2 absolute top-8 ${messageSender === "user"?"left-20":"right-20"}`}>
      <div
